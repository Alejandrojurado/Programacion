        		...
        		<div class="carousel-team owl-carousel">
        			<div class="item">
		        		<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-1.jpg);"></div>
		        			<h2>Danica Lewis</h2>
        			...
        			<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-2.jpg);"></div>
		        			<h2>Nicole Simon</h2>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-3.jpg);"></div>
		        			<h2>Cloe Meyer</h2>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-4.jpg);"></div>
	        		...
	        		<div class="item">
	        			<a href="#" class="team text-center">
		        			<div class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-5.jpg);"></div>
		        			<h2>Dave Buff</h2>
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
    		...
    		<div class="row no-gutters">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
    					<img src="<?php echo get_template_directory_uri(); ?>/images/work-1.jpg" class="img-fluid" alt="Colorlib Template">  
	    				
	    				<div class="text">
	    					<span>Stylist</span>
	    					<h3><a href="project.html">Beard</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
    					<img src="<?php echo get_template_directory_uri(); ?>/images/work-2.jpg" class="img-fluid" alt="Colorlib Template">  
	    				
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Haircut</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-2.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
    					<img src="<?php echo get_template_directory_uri(); ?>/images/work-3.jpg" class="img-fluid" alt="Colorlib Template">  
	    				
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Hairstylist</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-3.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
    					<img src="<?php echo get_template_directory_uri(); ?>/images/work-4.jpg" class="img-fluid" alt="Colorlib Template">	    				
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Haircut</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-4.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<img src="<?php echo get_template_directory_uri(); ?>/images/work-5.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-5.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				...
	    				<img src="<?php echo get_template_directory_uri(); ?>/images/work-6.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Fashion</span>
	    					<h3><a href="project.html">Model</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-6.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="<?php echo get_template_directory_uri(); ?>/images/work-7.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-7.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="project">
	    				<img src="<?php echo get_template_directory_uri(); ?>/images/work-8.jpg" class="img-fluid" alt="Colorlib Template">
	    				<div class="text">
	    					<span>Beauty</span>
	    					<h3><a href="project.html">Makeup</a></h3>
	    				</div>
	    				<a href="<?php echo get_template_directory_uri(); ?>/images/work-8.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="icon-expand"></span>
	    				</a>
    				</div>
    			</div>
      ...
      <div class="container">
        <div class="row ftco-animate justify-content-center">
        	<div class="col-md-6 col-lg-5 d-flex">
        		<div class="testimony-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/testimony-img.jpg);"></div>
        	</div>
	            ...
	            <div class="carousel-testimony owl-carousel ftco-animate">
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-1.jpg)">
		                  </div>
		                  <div class="pos ml-3">
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-2.jpg)">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-3.jpg)">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  <div class="user-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-4.jpg)">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
	              ...
	              <div class="item">
	                <div class="testimony-wrap pb-4">
	                  ...
	                  <div class="d-flex">
		                  ...
		                  <div class="user-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/stylist-5.jpg)">
		                  </div>
		                  <div class="pos ml-3">
		                  	<p class="name">Jeff Nucci</p>
		                    <span class="position">Businessman</span>
