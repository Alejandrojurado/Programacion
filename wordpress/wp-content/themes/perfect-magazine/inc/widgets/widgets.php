    ...
    class Perfect_Magazine_Widget_Vertical_List extends Perfect_Magazine_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'disable_image_zoom' => array(
                    'label' => __('Enable Featured Image click to single Post', 'perfect-magazine'),
                    'type' => 'checkbox',
                    'default' => false,
                ),
                'post_number' => array(
                    ...
                    <div class="row">
                        <?php foreach ($all_posts as $key => $post) : ?>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12" data-mh="list-height">
                                <article class="">
                                    <?php if (false === $params['disable_image_zoom']) { ?>
        ...
        function widget($args, $instance)
        {
            ...
            <div class="widget-wrapper widget-wrapper-carousel">
                <div class="container">
                    ...
                    <div class="tm-carousel-widget" data-slick='{"rtl": <?php echo($rtl_class); ?>}'>
                        <?php foreach ($all_posts as $key => $post) : ?>
                            <?php setup_postdata($post); ?>
                            <?php if (has_post_thumbnail()) {
                                $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full');
