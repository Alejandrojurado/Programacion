...
<div>
    <img class="banner d-none d-sm-block" src="https://cdn.pixabay.com/photo/2017/03/20/21/00/server-2160321_960_720.jpg">
...
<div>
    <div class="row aft-banner">
        ...
        <div class="col-sm-4">
            <div class="domains">.com $10 | .net $8 | .org $12</div>
                ...
                <div id="quote-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive "
                                                                                                src="<?php echo get_template_directory_uri() ;?>/img/customer1.jpg"
                                                                                                alt="">
                        </li>
                        ...
                        <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive"
                                                                                 src="https://cdn.pixabay.com/photo/2016/04/15/18/05/computer-1331579__340.png" alt="">
                        </li>
                    </ol>
                    </a>
